  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        <Link href={`/products/${product.slug}`}>
          <h3 className="font-semibold text-slate-900 dark:text-white text-sm line-clamp-2 hover:text-[#2563EB] transition-colors mb-2">
            {product.name}
          </h3>
        </Link>
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="text-right">
            <p className="text-xs text-slate-400">{t.products.moq}</p>
