...
import { ShoppingBag, Tag, Building2, MapPin } from "lucide-react";
      ...
      <div className="container-base flex flex-col sm:flex-row items-center justify-between gap-4">
        <div>
          ...
          <div className="flex items-center gap-3 mt-3 flex-wrap">
            <span className="flex items-center gap-1.5 text-xs text-white/90 font-medium bg-white/10 px-2.5 py-1 rounded-full border border-white/10">
