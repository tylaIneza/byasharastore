    ...
    <section className="py-12 container-base">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          ...
          <h3 className="text-2xl font-black mb-2">Bulk Deals — Up to 30% Off</h3>
          <p className="text-blue-100 text-sm mb-5">Order 50+ units and unlock our best wholesale pricing automatically.</p>
          <Link
            href="/products"
        ...
        >
          ...
          <h3 className="text-2xl font-black mb-2">Free Delivery on 500K+ Orders</h3>
          <p className="text-slate-400 text-sm mb-5">Rwanda & Eastern DRC. Same-day processing. Fast, reliable delivery to your doorstep.</p>
          <Link
            href="/products"
