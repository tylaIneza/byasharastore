...
export const metadata: Metadata = {
  title: "Privacy Policy — NEWGEN STORE",
  description: "Privacy Policy for NEWGEN STORE, compliant with Rwandan data protection law (Law No. 058/2021).",
};
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 p-8 shadow-sm prose-custom space-y-8 text-slate-700 dark:text-slate-300 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>
              <strong>NEWGEN STORE</strong> (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) is a wholesale electronics supplier registered and operating in Rwanda. Our principal place of business is at Nyabugogo, Kigali, Rwanda. We also operate a branch in Rubavu, Western Province.
            </p>
            <p className="mt-2">
              For questions about this policy or your personal data, contact our Data Protection Officer at: <a href="mailto:info@newgen.com" className="text-[#2563EB] hover:underline">info@newgen.com</a> or <strong>+250 782 545 277</strong>.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">To exercise any of these rights, contact us at <a href="mailto:info@newgen.com" className="text-[#2563EB] hover:underline">info@newgen.com</a>. We will respond within <strong>30 days</strong> as required by law.</p>
          </section>
