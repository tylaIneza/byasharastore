...
export const metadata: Metadata = {
  title: "Terms of Service — BYASHARA STORE",
  description: "Terms of Service for BYASHARA STORE, governed by Rwandan law.",
};
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 p-8 shadow-sm space-y-8 text-slate-700 dark:text-slate-300 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>
              These Terms of Service (&quot;Terms&quot;) constitute a legally binding agreement between <strong>BYASHARA STORE</strong> (&quot;we&quot;, &quot;us&quot;, &quot;Seller&quot;), a wholesale electronics business registered and operating in Rwanda, and you (&quot;Buyer&quot;, &quot;Customer&quot;) who accesses or places an order through our website.
            </p>
            <p className="mt-2">
          ...
          <section>
            ...
            <p>
              All products listed on BYASHARA STORE are sourced from verified suppliers and are 100% authentic. Where manufacturer warranties apply, these pass directly to the Buyer. BYASHARA STORE does not provide independent warranties beyond those offered by manufacturers unless expressly stated.
            </p>
            <p className="mt-2">
          ...
          <section>
            ...
            <p>
              All content on this website — including but not limited to product images, descriptions, logos, and design — is the property of BYASHARA STORE or used under licence. You may not reproduce, distribute, or use any content from this website for commercial purposes without our prior written consent, in accordance with Rwandan intellectual property law.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              To the maximum extent permitted by Rwandan law, BYASHARA STORE is not liable for:
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1">
